...
async function newChat() {
    currentChatId = null;
    document.getElementById('chatBox').innerHTML = ''; // EMPTY - NO INTRO
...
async function loadChat(chatId) {
    ...
    messages.forEach(m => addMessage(m.role, m.content, m.created_at)); // JUST LOAD DB
    if(window.innerWidth < 768) toggleSidebar();
    loadSidebar();
}
...
// REMOVED showIntroduction() - INTRO NOW COMES FROM BACKEND
