...
function renderAI(text) {
    try {
        ...
        // v3.0: Parse citations into Perplexity style cards
...
function addMessage(role, text, timestamp = null) {
    ...
    if(role === 'ai') {
        ...
        // USER: Show exactly what user typed. No cleaning
            ...
            for(const line of lines) {
                if(line.startsWith('data: ')) {
                    ...
                    if(data.startsWith('[CHAT_ID]')) {
                        ...
                        fullText += data;
                        // Render on every chunk for smooth typing
