...
let userId = "00000-0000-0000-0000-000001"; // VALID UUID FOR GUEST MODE
let isSending = false;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadSidebar();
    showIntroduction(); // SHOW INTRO ON FIRST LOAD
});

function showIntroduction() {
    document.getElementById('bcorpFace').style.display = 'none'; // hide brain hero
    addMessage('ai', INTRO_TEXT);
}
...
async function newChat() {
    currentChatId = null;
    document.getElementById('chatBox').innerHTML = ''; // CLEAR
    document.getElementById('bcorpFace').style.display = 'none'; // HIDE HERO
    showIntroduction(); // SHOW INTRO INSTEAD
...
async function loadChat(chatId) {
    ...
    document.getElementById('bcorpFace').style.display = 'none';
