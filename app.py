...
app = Flask(__name__, static_folder="static", template_folder="templates") # static folder explicit
...
# SUPABASE MEMORY FUNCTIONS - RENAMED FOR BRAIN 3.0
