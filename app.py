...
import os, re, time, io, PyPDF2, traceback, json, subprocess, uuid
...
# FAKE UUID FOR GUEST MODE - MUST BE VALID UUID FORMAT
GUEST_ID = "00000000-0000-0000-0000-000001"
...
def get_user_id(req):
    uid = req.args.get("user_id") or req.form.get("user_id") or GUEST_ID
    # Validate UUID, fallback to guest
    try:
        uuid.UUID(uid)
        return uid
    except:
