...
def health():
    ...
    def get_chat_compat_route(chat_id):
        ...
        return jsonify({"chat":chat,"messages":list_messages(chat_id,uid,limit=200)})
    ...
    def chat():
        uid=current_user_id()
        question=request.form.get("question",request.form.get("message","")).strip()
        ...
        if uploaded_file and uploaded_file.filename:
            ...
            try:
                ...
                file_meta={"name":original_name,"type":ext,"temp_path":filepath,"size":size}
