...
print("GROQ_API_KEY exists:", bool(getattr(config, 'GROQ_API_KEY', None)))
...
@app.route("/config")
def get_config():
    # FIX: Return both keys so frontend can login
    try:
        return jsonify({
            "supabase_url": config.SUPABASE_URL, 
            "supabase_key": config.SUPABASE_ANON_KEY # This is what frontend needs
        })
