...
def needs_image(query):
    keywords = ['imagine', 'generate image', 'create image', 'draw', 'picture of', 'make me a']
    return any(word in query.lower() for word in keywords)
    ...
    try:
        ...
        if needs_image(user_question):
            ...
            if image_url:
                ...
                return jsonify({"error": "Image generation failed. Check REPLICATE_API_TOKEN and credits"}), 500
