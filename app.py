...
print("=== BRAIN 3.0 v3.8.1 ULTRA STARTING ===")
            ...
            try:
                ...
                for chunk in stream:
                    if chunk.choices and chunk.choices[0].delta.content:
                        ...
                        if len(buffer) > 50:
                            chunk_clean = clean_output(buffer) # CLEAN BEFORE SEND
                ...
                if tool_calls:
                    ...
                    for chunk in stream2:
                        if chunk.choices and chunk.choices[0].delta.content:
                            content = clean_output(chunk.choices[0].delta.content) # CLEAN AGAIN
                            full += content
                ...
                full = clean_output(full) # FINAL CLEAN
