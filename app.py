...
def allowed_file(filename): # FIXED: removed the random "k"
    return '.' in filename and filename.rsplit('.', 1)[1].lower() in ALLOWED_EXTENSIONS

def clean_markdown(text):
    # FIX: Stop cutting words - Clean only once at the end
...
BAD: Overvie, billio, than14, 2.5times, Architecture- Scalable
GOOD:
### Architecture
    ...
    try:
        ...
        def generate():
            ...
            try:
                ...
                # FIX: ONLY CLEAN ONCE AT THE END - stops word cutoff
