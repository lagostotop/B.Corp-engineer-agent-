...
def clean_markdown(text):
    ...
    text = re.sub(r'(B\.CORP)(\s*)(\d)', r'\1 \3', text)
...
def generate_image(prompt):
    try:
        ...
        print(f"[REPLICATE] Error: {traceback.format_exc()}")
...
Address user as "CEO". Keep answers 5-10 sentences. End with "Would you like me to... CEO?" """
...
def ask():
    try:
        ...
        model = "llama-3.2-11b-vision-preview" if has_file else "llama-3.3-70b-versatile" # FIXED: new vision model
