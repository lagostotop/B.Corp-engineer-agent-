...
print("=== BRAIN 3.0 v4.0 ULTRA STARTING ===")
...
def final_clean(text):
    # ONLY RUN ONCE AT THE END. This preserves markdown during streaming
    if not text: return ''
            ...
            try:
                ...
                for chunk in stream:
                    if chunk.choices and chunk.choices[0].delta.content:
                        # UPGRADE: SEND RAW. NO CLEANING DURING STREAM
                ...
                if tool_calls:
                    ...
                    for chunk in stream2:
                        if chunk.choices and chunk.choices[0].delta.content:
                            content = chunk.choices[0].delta.content # RAW
                            full += content
                            yield f"data: {content}\n\n"
                ...
                # UPGRADE: CLEAN ONLY ONCE AT THE END
