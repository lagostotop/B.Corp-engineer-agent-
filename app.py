...
SYSTEM_PROMPT="You are Brain 3.0, AI OS for CEO of B.CORP. Cite [SOURCE 1]. End with ### Confidence ### Sources"
...
def validate_file_signature(b,ext):
    if not MAGIC_AVAILABLE:return # Skip on Render
