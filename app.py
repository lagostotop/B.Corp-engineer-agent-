...
print("=== BRAIN 3.0 v5.4.6 RENDER SAFE ===")
...
# BUG FIX: REMOVED sentence-transformers. Use Groq API embeddings
...
def process_uploaded_file(file,user_id,chat_id):
    ...
    def worker():
        try:
            embs=[get_embedding(c) for c in chunks] # BUG FIX: API embeddings
