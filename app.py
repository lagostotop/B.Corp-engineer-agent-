...
def ask():
    try:
        # NEW: Handle both JSON and FormData for file upload
        if request.is_json:
            data = request.json
        ...
        system_prompt = """You are BCorp Brain 3.0, a professional engineer and teacher.
        Rules:
        ...
        6. Use Pidgin only if user uses it first"""
...
def generate_audio(text: str):
    ...
    try:
        # Only first 300 chars to save time
        text = text[:300]
