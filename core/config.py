...
class Settings:
    ...
    supabase_publishable_key:str=os.getenv("SUPABASE_PUBLISHABLE_KEY") or os.getenv("SUPABASE_ANON_KEY","")
...
settings=Settings(allowed_origins=_csv(os.getenv("ALLOWED_ORIGINS"),"*"))