...
class ModelRouter:
    ...
    def select_model(
        ...
        if mode in ("reasoning","deep_research"):
        ...
        if len(q)<50 and any(
            x in q.split()
            for x in ("hi","hello","thanks","ok","yes","no")
        ):
    ...
    def build_messages(
        ...
        system=(
            ...
            "Do not reveal private chain-of-thought, internal tool calls, "
            "or hidden reasoning. "
